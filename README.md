...
| [to](/src/cmd/to.rs#L2)✨<br>🚀🗄️ | Convert CSV files to [Parquet](https://parquet.apache.org), [PostgreSQL](https://www.postgresql.org), [SQLite](https://www.sqlite.org/index.html), Excel XLSX and [Data Package](https://datahub.io/docs/data-packages/tabular). |
...
The `to` command converts CSVs to Excel `.xlsx`, [Parquet](https://parquet.apache.org) & [Data Package](https://datahub.io/docs/data-packages/tabular) formats, and populates [PostgreSQL](https://www.postgresql.org) and [SQLite](https://www.sqlite.org/index.html) databases.
