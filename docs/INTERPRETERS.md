...
[Luau 0.682](https://github.com/Roblox/luau/releases/tag/0.682) is currently embedded - qsv's policy is to use the latest stable Luau version at the time of each qsv release.
