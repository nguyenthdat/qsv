...
🐻‍❄️: command powered/accelerated by [![polars 0.47.1](https://img.shields.io/badge/polars-0.47.1-blue)](https://github.com/pola-rs/polars/releases/tag/rs-0.47.0) at the [py-1.30.0-beta.1 tag](https://github.com/pola-rs/polars/releases/tag/py-1.30.0-beta.1).  
