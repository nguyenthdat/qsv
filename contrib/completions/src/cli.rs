...
use crate::cmd::{
    ...
    fmt::fmt_cmd, foreach::foreach_cmd, frequency::frequency_cmd, geocode::geocode_cmd, geoconvert::geoconvert_cmd,
    ...
    pivotp::pivotp_cmd, pro::pro_cmd, prompt::prompt_cmd, pseudo::pseudo_cmd, python::py_cmd,
    rename::rename_cmd, replace::replace_cmd, reverse::reverse_cmd, safenames::safenames_cmd,
    sample::sample_cmd, schema::schema_cmd, search::search_cmd, searchset::searchset_cmd,
    select::select_cmd, slice::slice_cmd, snappy::snappy_cmd, sniff::sniff_cmd, sort::sort_cmd,
